	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"80%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="13">
					<el-form-item label="几届学生" prop="jijiexuesheng">
						<el-input class="list_inp" v-model="form.jijiexuesheng" placeholder="几届学生"
							 type="text" 							:readonly="!isAdd||disabledForm.jijiexuesheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="13">
					<el-form-item label="捐款金额" prop="juankuanjine">
						<el-input class="list_inp" v-model="form.juankuanjine" placeholder="捐款金额"
							 type="text" 							:readonly="!isAdd||disabledForm.juankuanjine?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jijiexuesheng'){
					form.value.jijiexuesheng = row[x];
					disabledForm.value.jijiexuesheng = true;
					continue;
				}
				if(x=='shouji'){
				...
				if(x=='juankuanjine'){
					form.value.juankuanjine = row[x];
					disabledForm.value.juankuanjine = true;
					continue;
				}
			}
			if(row){
		...
		context?.$http({
			...
			if(json.hasOwnProperty('jijiexuesheng') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.jijiexuesheng = json.jijiexuesheng
				disabledForm.value.jijiexuesheng = true;
			}
