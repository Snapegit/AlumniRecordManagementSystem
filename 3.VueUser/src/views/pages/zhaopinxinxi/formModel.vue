			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						{{detail.zhaopinbiaoti}}
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">公司地址</div>
					<div  class="info_text" >{{detail.gongsidizhi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">薪资</div>
					<div  class="info_text" >{{detail.xinzi}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">经验</div>
					<div  class="info_text" >{{detail.jingyan}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">职位描述</div>
					<div  class="info_text" >{{detail.zhiweimiaoshu}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('zhaopinxinxi','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('zhaopinxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.zhaopinbiaoti
			bannerList.value = res.data.data.gongsitupian?res.data.data.gongsitupian.split(','):[]
