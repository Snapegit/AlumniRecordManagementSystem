					...
					<mySwiper :data="list" :type="3"
						...
						<template #default="scope">
							<div class="data_item animation_box" @click.stop="detailClick(scope.row.id)" >
								<div class="data_img_box" v-if="scope.row.gongsitupian && scope.row.gongsitupian.substr(0,4)=='http'" @click.stop="preViewClick(scope.row.gongsitupian)">
									<el-image class="data_img" :src="scope.row.gongsitupian" fit="cover"></el-image>
								</div>
								<div class="data_img_box" v-else @click.stop="preViewClick($config.url+scope.row.gongsitupian.split(',')[0])">
									<el-image class="data_img" :src="scope.row.gongsitupian?$config.url + scope.row.gongsitupian.split(',')[0]:''"
										fit="cover"></el-image>
								</div>
								<div class="data_content">
									<div class="data_title">{{scope.row.zhaopinbiaoti}}</div>
									<div class="data_title">{{scope.row.gongsidizhi}}</div>
