			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						{{detail.choukuanbiaoti}}
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">筹款副标题</div>
					<div  class="info_text" >{{detail.choukuanfubiaoti}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'捐款')" @click="juankuanxinxionAcross('捐款','juankuanxinxi','','','')" type="warning">捐款</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('choukuanxinxi','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('choukuanxinxi','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('choukuanxinxi','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
		<el-tabs type="border-card" v-model="activeName" class="tabs_view">
			<el-tab-pane label="筹款描述" name="first">
				<div v-html="detail.choukuanmiaoshu"></div>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
<script setup>
	...
	const getDetail = () => {
		context?.$http({
			...
			title.value = res.data.data.choukuanbiaoti
	...
	const juankuanxinxionAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
