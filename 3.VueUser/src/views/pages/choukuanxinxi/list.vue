	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 0 40px","margin":"0 auto","overflow":"hidden","borderRadius":"4px","background":"#fff","width":"80%","position":"relative"}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('choukuanxinxi','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
						...
						<template #default="scope">
							<div class="data_item animation_box" @click.stop="detailClick(scope.row.id)" >
								...
								<div class="data_content">
									<div class="data_title">{{scope.row.choukuanbiaoti}}</div>
									<div class="data_title">{{scope.row.choukuanfubiaoti}}</div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/choukuanxinxiAdd')
	}
	//判断是否从个人中心跳转
	...
	const detailClick = (id) => {
		router.push('choukuanxinxiDetail?id=' + id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){
