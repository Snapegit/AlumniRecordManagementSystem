	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="招聘标题" prop="zhaopinbiaoti">
							<el-input class="list_inp" v-model="form.zhaopinbiaoti" placeholder="招聘标题"
								 type="text" 								:readonly="!isAdd||disabledForm.zhaopinbiaoti?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="公司地址" prop="gongsidizhi">
							<el-input class="list_inp" v-model="form.gongsidizhi" placeholder="公司地址"
								 type="text" 								:readonly="!isAdd||disabledForm.gongsidizhi?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="经验" prop="jingyan">
							<el-input class="list_inp" v-model="form.jingyan" placeholder="经验"
								 type="text" 								:readonly="!isAdd||disabledForm.jingyan?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="职位描述" prop="zhiweimiaoshu">
							<el-input class="list_inp" v-model="form.zhiweimiaoshu" placeholder="职位描述"
								 type="text" 								:readonly="!isAdd||disabledForm.zhiweimiaoshu?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="公司图片" prop="gongsitupian">
							<uploads
								:disabled="!isAdd||disabledForm.gongsitupian?true:false"
								action="file/upload" 
								tip="请上传公司图片" 
								:limit="3" 
								style="width: 100%;text-align: left;"
								:fileUrls="form.gongsitupian?form.gongsitupian:''" 
								@change="gongsitupianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const type = ref('')
	//公司图片上传回调
	const gongsitupianUploadSuccess=(e)=>{
		form.value.gongsitupian = e
	}
	//methods
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='zhaopinbiaoti'){
					form.value.zhaopinbiaoti = row[x];
					disabledForm.value.zhaopinbiaoti = true;
					continue;
				}
				if(x=='gongsidizhi'){
				...
				if(x=='jingyan'){
					form.value.jingyan = row[x];
					disabledForm.value.jingyan = true;
					continue;
				}
				if(x=='xueli'){
				...
				if(x=='zhiweimiaoshu'){
					form.value.zhiweimiaoshu = row[x];
					disabledForm.value.zhiweimiaoshu = true;
					continue;
				}
				if(x=='zhanghao'){
				...
				if(x=='gongsitupian'){
					form.value.gongsitupian = row[x];
					disabledForm.value.gongsitupian = true;
					continue;
				}
			}
			if(row){
	...
	//提交
	const save=()=>{
		if(form.value.gongsitupian!=null) {
			form.value.gongsitupian = form.value.gongsitupian.replace(new RegExp(context?.$config.url,"g"),"");
		}
